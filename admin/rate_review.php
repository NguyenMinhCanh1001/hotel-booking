                 ...
                 <div class="card border-0 shadow mb-4">
                     <div class="card-body">
                         ...
                         <div class="text-end mb-4">
                             <a href="?seen=all" class="tbn btn-dark rounded-pill shadow-none btn-sm"><i
                                     class="bi bi-check-all"></i>Mark all read</a>
                             <a href="?del=all" class="tbn btn-danger rounded-pill shadow-none btn-sm"><i
                         ...
                         <div class="table-responsive-md">
                             <table class=" table table-hover border">
                                 ...
                                 <tbody>
                                     <?php
                                        $q = "SELECT rr.*,uc.name AS uname, uc.profile, r.name AS rname FROM `rating_review` rr
