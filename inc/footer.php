  ...
  login_form.addEventListener('submit', (e)=>{
    ...
    xhr.onload = function() {
       if(this.responseText == 'inv_email_mob'){
        ...
        alert('error','Tài khoản của bạn đã bị khóa! Vui lòng liên hệ với Admin!');
       }
  ...
  forgot_form.addEventListener('submit', (e)=>{
    ...
    xhr.onload = function() {
       if(this.responseText == 'inv_email'){
        ...
        alert('error','Khôi phục tài khoản thất bại! Server Down');
      }
       else{
        alert('success','Link đặt lại mật khẩu đã được gửi đến email của bạn.');
        forgot_form.reset();
       }
    }
