    ...
    <div class="row">
      ...
      <div class="col-12 my-5 px-4">
        ...
        <div style="font-size: 15px;">
          ...
          <a href="#" class="text-primary text-decoration-none">Hồ sơ cá nhân</a>
        </div>
      </div>
      ...
      <div class="col-12 mb-5 px-4">
       <div class="bg-white p-3 p-md-4 rounded shadow-sm">
        <form id="info-form">
          ...
          <button type="submit" class="btn text-white custom-bg shadown">Save</button>
        </form>
       </div>
      ...
      <div class="col-md-4 mb-5 px-4">
       <div class="bg-white p-3 p-md-4 rounded shadow-sm">
        <form id="profile-form">
          ...
          <label class="form-label">Ảnh mới của bạn</label>
