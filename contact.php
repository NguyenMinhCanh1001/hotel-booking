      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        ...
        <iframe class="w-100 rounded mb-4"  height="320px" src="<?php echo $contact_r['iframe'] ?>" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          ...
          <h5 class="mt-4">Số liên hệ</h5>
            <a href="tel: <?php echo $contact_r['pn1'] ?>" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone"></i>
          ...
          <a href="mailto: <?php echo $contact_r['email'] ?>" class="d-inline-block text-decoration-none text-dark"><i class="bi bi-envelope"></i>
          ...
          ?>
            <a href="<?php echo $contact_r['fb']; ?>"target="_blank" class="d-inline-block mb-2 text-dark fs-5 me-2 text-decoration-none ">
              <i class="bi bi-facebook me-l"></i> 
          </a>
            
            <a href="<?php echo $contact_r['insta']; ?>" target="_blank" class="d-inline-block mb-2 text-dark fs-5 text-decoration-none">
