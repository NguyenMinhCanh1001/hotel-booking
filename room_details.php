          ...
          <div>
            ...
            <div>
              <div class="profile d-flex align-items-center mb-4">
                <img src="/images/TienNghi/star.png" width="30px">
              ...
              <div class="rating d-flex">
                <i class="bi bi-star-fill text-warning" aria-label="xếp hạng sao"></i>
                <i class="bi bi-star-fill text-warning" aria-label="xếp hạng sao"></i>
                <i class="bi bi-star-fill text-warning" aria-label="xếp hạng sao"></i>
                <i class="bi bi-star-half text-warning" aria-label="xếp hạng sao nửa"></i>
              </div>
            </div>
          </div>
