...
<head>
    ...
    <title>UTH HOTEL - Cở sở vật chất</title>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4 border-top border-4 border-dark pop">
          ...
          <img src="/images/TienNghi/wifi.png" width="40px">
          <h5 class="m-0 ms-3">
            Wifi
          </h5>
          </div>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati illum quod iure, expedita sequi ipsam ex?
          </p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-5 px-4">
